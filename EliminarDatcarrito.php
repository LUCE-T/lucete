...
<body>
    ...
    if (!$conexion) {
        ...
        echo "<h1>BORRAR ALGUNA VENTA DEL CARRITO DE COMPRAS :( </h1>";
    }

    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $id_carrito = $_POST["id_carrito"];

        $delete_query = "DELETE FROM carrito_de_compras WHERE id_carrito = :id_carrito";
    ...
    <form method="post" action="">
        <label for="id_carrito">ID Carrito a Eliminar:</label>
