...
<body>
    ...
    if (!$conexion) {
        ...
        echo "<h1>BIENVENIDO. QUIERES VER QUIENES SON LOS CLIENTES</h1>"; /* Título con fondo rosa y texto blanco */
    }

    $query = 'SELECT * FROM clientesl';
    ...
    <table border="1">
        ...
        while ($row = oci_fetch_array($statement, OCI_ASSOC + OCI_RETURN_NULLS)) {
            ...
            echo "<td>" . ($row['DOMICILIO'] !== null ? htmlentities($row['DOMICILIO'], ENT_QUOTES) : "&nbsp; ") . "</td>\n";
