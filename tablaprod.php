...
<body>
    ...
    if (!$conexion) {
        ...
        echo "<h1>BIENVENIDO OBSERVA CUANTOS PRODUCTOS TENEMOS</h1>"; /* Título con fondo rosa y texto blanco */
    }
    ...
    <table border="1">
        ...
        while ($row = oci_fetch_array($statement, OCI_ASSOC + OCI_RETURN_NULLS)) {
            ...
            echo "<td>" . ($row['PRECIO'] !== null ? htmlentities($row['PRECIO'], ENT_QUOTES) : "&nbsp; ") . "</td>\n";
