...
<body>
    ...
    if (!$conexion) {
        ...
        echo "<h1>ALGO NO TE GUSTO PUEDES BORRARLO :( </h1>";
    }

    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        $id_inventario = $_POST["id_inventario"];

        $delete_query = "DELETE FROM inventario WHERE id_inventario = :id_inventario";
    ...
    <form method="post" action="">
        <label for="id_inventario">ID Inventario a Eliminar:</label>
