...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $insert_query = "INSERT INTO clientesl (id_cliente, nombre, apellido_pat, apellido_mat, domicilio, num_telefonico) VALUES (:id_cliente, :nombre, :apellido_pat, :apellido_mat, :domicilio, :num_telefonico)";
        ...
        oci_bind_by_name($statement, ":domicilio", $domicilio);
    ...
    <form method="post" action="">
        ...
        <input type="number" name="num_telefonico" id="num_telefonico" required><br>
