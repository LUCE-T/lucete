...
<body>
    ...
    if (!$conexion) {
        ...
        echo "<h1>CARRITO DE COMPRAS</h1>"; /* Título con fondo rosa y texto blanco */
    }
    ...
    ?>
       ...
       <a href="../consultas/consulta7.php">REGRESAR</a>
           ...
           <a href="../PDF/generarpdf.php">IMPRIMIR</a>
    ...
    <table border="1">
        ...
        while ($row = oci_fetch_array($statement, OCI_ASSOC + OCI_RETURN_NULLS)) {
            echo "<tr>\n";
            echo "<td>" . ($row['ID_CARRITO'] !== null ? htmlentities($row['ID_CARRITO'], ENT_QUOTES) : "&nbsp;") . "</td>\n";
            ...
            echo "<td>" . ($row['TOTAL'] !== null ? htmlentities($row['TOTAL'], ENT_QUOTES) : " &nbsp;") . "</td>\n";
